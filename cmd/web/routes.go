...
func (app application) minimap(c *gin.Context) {
  ...
  c.HTML(http.StatusOK, "partials/minimap.html.gotmpl", gin.H {
...
func (app application) maze(c *gin.Context) {
  ...
  if c.GetHeader("HX-Request") == "" {
    c.HTML(http.StatusOK, "pages/maze.html.gotmpl", data)
  } else {
    c.HTML(http.StatusOK, "partials/maze-partial.html.gotmpl", data)
  }
}
...
func (app application) room(c *gin.Context) {
  ...
  c.HTML(http.StatusOK, "partials/room-partial.html.gotmpl", gin.H {
    "Room": room,
  })
}
